...
$stmt = $db->prepare("SELECT devices.name as devicename, devices_alarms.*, alarms.name as alarmname, devices.ip as ip
FROM devices_alarms INNER JOIN devices ON devices.id = devices_alarms.device_id
